  ...
  try {
    ...
    if (stockSymbols.length > 0) {
      const mockStockPrices: Record<string, { price: number; change24h: number }> = {
        AAPL: { price: 178.5 + (Math.random() - 0.5) * 5, change24h: (Math.random() - 0.5) * 4 },
        MSFT: { price: 378.85 + (Math.random() - 0.5) * 8, change24h: (Math.random() - 0.5) * 3 },
        TSLA: { price: 245.5 + (Math.random() - 0.5) * 10, change24h: (Math.random() - 0.5) * 5 },
        SPY: { price: 448.2 + (Math.random() - 0.5) * 6, change24h: (Math.random() - 0.5) * 2 },
        GOLD: {
          price: 2020.0 + (Math.random() - 0.5) * 15,
