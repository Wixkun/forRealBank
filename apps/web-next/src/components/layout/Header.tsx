...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 bg-linear-to-br from-teal-950/90 via-teal-900/75 to-teal-800/75 backdrop-blur border-b border-white/10">
